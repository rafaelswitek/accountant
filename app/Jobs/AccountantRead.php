...
class AccountantRead implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $result = $txtService->readFile('app/contadores.txt');
        ...
        for ($i = 0; $i < $numBatches; $i++) {
            ...
            AccountantProcess::dispatch($batch, $offset, $batchSize)->delay(now()->addMinutes(1));
        }
    }
}
