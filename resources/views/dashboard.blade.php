    ...
    <x-slot name="header">
        <div class="flex">
            <div class="flex me-2">
                ...
                <button
                    class="flex items-center bg-gray-50 border border-gray-300 hover:bg-gray-100 text-gray-900 text-sm py-2 px-4">
            ...
            <button type="button"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    data-lucide="filter" class="lucide lucide-filter">
