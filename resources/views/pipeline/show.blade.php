...
<script>
    ...
    const formNewDeal = document.getElementById('formNewDeal');

    formNewDeal.addEventListener('submit', function(event) {
        event.preventDefault();
        if (checkIfCompanyIsDefined()) {
            formNewDeal.submit();
        }
    });

    function checkIfCompanyIsDefined() {
